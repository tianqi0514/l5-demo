...
const SYSTEMS = [
  { id: 's1', name: 'POS系统', vendor: '商米', type: '收银', status: 'connected', lastSync: '2秒前', dataRate: '12K/min', icon: Server },
  { id: 's2', name: 'ERP系统', vendor: 'SAP', type: '企业资源', status: 'connected', lastSync: '5分钟前', dataRate: '3K/min', icon: Database },
  { id: 's3', name: 'WMS仓储系统', vendor: '富勒', type: '仓储', status: 'connected', lastSync: '1分钟前', dataRate: '8K/min', icon: Database },
  { id: 's4', name: '会员CRM', vendor: '自研', type: '会员', status: 'connected', lastSync: '10秒前', dataRate: '25K/min', icon: Database },
  { id: 's5', name: 'OMS订单中台', vendor: '自研', type: '订单', status: 'warning', lastSync: '15分钟前', dataRate: '1K/min', icon: Server },
  { id: 's6', name: 'SCM供应链', vendor: '金蝶', type: '供应链', status: 'connected', lastSync: '3分钟前', dataRate: '5K/min', icon: Database },
  { id: 's7', name: 'BI报表平台', vendor: '帆软', type: '分析', status: 'connected', lastSync: '1小时前', dataRate: '500/min', icon: Activity },
];
  ...
  return (
    <div className="h-full flex flex-col bg-white p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">L1 业务层 · ERP/POS/WMS/OMS/CRM</p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white p-4 border border-gray-200">
          ...
          <div className="text-2xl font-bold text-gray-900 mt-1">54.5M</div>
        </div>
      </div>
