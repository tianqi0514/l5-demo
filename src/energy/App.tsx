...
import {
  BrainCircuit, Database, Settings, Terminal, Workflow,
  ShieldCheck, Briefcase, Network, HardDrive, Layers,
  LayoutTemplate, ArrowLeft, Home, FileCheck, Scale, AlertTriangle
} from 'lucide-react';
...
const navGroups = [
  {
    layer: 'L1: 业务系统层',
    items: [
      { id: 'iot', label: 'IoT设备接入', icon: AlertTriangle },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'skill', label: '技能市场', icon: ShieldCheck },
    ]
  },
  {
    layer: 'L5: 执行 & 可视化层',
    ...
    <div className="flex h-screen bg-gray-50 text-gray-900 font-sans overflow-hidden">
      <aside className="w-64 border-r border-gray-200 bg-white flex flex-col shrink-0">
        <div
          ...
          title="点击返回首页"
        >
          <div className="w-8 h-8 rounded bg-gradient-to-br from-slate-600 to-slate-800 flex items-center justify-center text-white">
            <FileCheck size={18} />
          </div>
          <div>
            <h1 className="text-sm font-semibold text-gray-900 tracking-wider uppercase">采购合规中台</h1>
            <p className="text-[10px] text-gray-500 font-mono tracking-widest uppercase">Procurement Compliance OS</p>
          </div>
        </div>
