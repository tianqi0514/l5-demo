...
import { Store, Grid3X3, Plus } from 'lucide-react';
      ...
      {showSidebar && (
        <div className="w-72 bg-white border-r border-gray-200 flex flex-col shrink-0">
          ...
          <div className="flex-1 p-4 space-y-1 overflow-y-auto">
            <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all bg-gray-900 text-white shadow-lg shadow-gray-200">
              <Store size={20} />
              <div className="flex-1 min-w-0">
                <div className="font-medium text-sm">技能市场</div>
                <div className="text-xs text-gray-400 truncate">浏览与管理 Skills</div>
              </div>
            </button>
          </div>
