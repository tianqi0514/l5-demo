...
// ============================================================
// Roles (Energy Procurement Compliance, 6 Levels)
// ============================================================
const USERS: Record<string, { id: string; title: string; initial: string; level: string; scope: string }> = {
  // L1 Strategic
  u_001: { id: 'u_001', title: 'CEO', initial: 'C', level: '战略层', scope: '全集团 · 4大区 · 200+项目' },
  u_002: { id: 'u_002', title: '首席合规官', initial: '合', level: '战略层', scope: '集团合规 · 全口径' },
  // L2 Management
  u_003: { id: 'u_003', title: '采购副总裁', initial: '采', level: '经营层', scope: '集团采购 · 全品类' },
  u_004: { id: 'u_004', title: '合规副总裁', initial: '规', level: '经营层', scope: '集团合规 · 制度建设' },
  u_005: { id: 'u_005', title: '审计副总裁', initial: '审', level: '经营层', scope: '集团审计 · 全覆盖' },
  u_006: { id: 'u_006', title: '财务副总裁', initial: '财', level: '经营层', scope: '集团财务 · 预算管控' },
  // L3 Execution
  u_011: { id: 'u_011', title: '招采合规经理', initial: '招', level: '执行层', scope: '招采部 · 招标合规审查' },
  u_012: { id: 'u_012', title: '供应商管理经理', initial: '供', level: '执行层', scope: '供应商管理部 · 准入/淘汰' },
  u_013: { id: 'u_013', title: '合同管理经理', initial: '合', level: '执行层', scope: '合同管理部 · 条款审查' },
  u_014: { id: 'u_014', title: '风控经理', initial: '风', level: '执行层', scope: '风控部 · 风险评估' },
  u_015: { id: 'u_015', title: '审计经理', initial: '计', level: '执行层', scope: '审计部 · 审计追踪' },
  u_016: { id: 'u_016', title: '法务经理', initial: '法', level: '执行层', scope: '法务部 · 法律合规' },
  u_017: { id: 'u_017', title: '成本分析师', initial: '成', level: '执行层', scope: '财务部 · 成本分析' },
  // L4 Regional
  u_021: { id: 'u_021', title: '华北采购中心总', initial: '华', level: '区域层', scope: '华北 · 京津冀蒙 · 年采60亿' },
  u_022: { id: 'u_022', title: '华东采购中心总', initial: '东', level: '区域层', scope: '华东 · 江浙沪皖 · 年采45亿' },
  u_023: { id: 'u_023', title: '华南采购中心总', initial: '南', level: '区域层', scope: '华南 · 粤闽琼 · 年采30亿' },
  u_024: { id: 'u_024', title: '西北采购中心总', initial: '西', level: '区域层', scope: '西北 · 陕甘宁新 · 年采35亿' },
  // L5 Category
  u_031: { id: 'u_031', title: '设备采购经理', initial: '设', level: '品类层', scope: '设备类 · 年采50亿' },
  u_032: { id: 'u_032', title: '材料采购经理', initial: '材', level: '品类层', scope: '材料类 · 年采40亿' },
  u_033: { id: 'u_033', title: '服务采购经理', initial: '服', level: '品类层', scope: '服务类 · 年采20亿' },
  u_034: { id: 'u_034', title: '工程采购经理', initial: '工', level: '品类层', scope: '工程类 · 年采60亿' },
  // L6 Operator
  u_041: { id: 'u_041', title: '高级采购员', initial: '购', level: '操作层', scope: '设备采购 · 华北区' },
  u_042: { id: 'u_042', title: '合规专员', initial: '专', level: '操作层', scope: '合规检查 · 日常巡检' },
  u_043: { id: 'u_043', title: '采购员', initial: '采', level: '操作层', scope: '材料采购 · 华东区' },
};

const USER_GROUPS = [
  { label: '战略层', ids: ['u_001', 'u_002'] },
  { label: '经营层', ids: ['u_003', 'u_004', 'u_005', 'u_006'] },
  { label: '执行层', ids: ['u_011', 'u_012', 'u_013', 'u_014', 'u_015', 'u_016', 'u_017'] },
  { label: '区域层', ids: ['u_021', 'u_022', 'u_023', 'u_024'] },
  { label: '品类层', ids: ['u_031', 'u_032', 'u_033', 'u_034'] },
  { label: '操作层', ids: ['u_041', 'u_042', 'u_043'] },
];

const CURRENT_USER = USERS['u_002'];

// ============================================================
// KPI Dashboard (Procurement Compliance)
// ============================================================
const GOALS = {
  compliance_rate: { name: '采购合规率', target: 95, actual: 87, unit: '%', progress: 0.916, deviation: -8, level: 'critical' as const },
  supplier_qualify: { name: '供应商合格率', target: 90, actual: 86, unit: '%', progress: 0.956, deviation: -4, level: 'warning' as const },
  bid_saving: { name: '招标节约率', target: 8, actual: 6.5, unit: '%', progress: 0.813, deviation: -1.5, level: 'warning' as const },
  contract_fulfill: { name: '合同履约率', target: 95, actual: 92, unit: '%', progress: 0.968, deviation: -3, level: 'warning' as const },
  risk_suppliers: { name: '风险供应商', target: 0, actual: 12, unit: '家', progress: 0, deviation: 12, level: 'critical' as const },
};

const GOAL_ALERTS = [
  { id: 'a1', severity: 'critical' as const, title: '采购合规率仅87%,低于目标95%', desc: 'Q1共47项不合规,主因:紧急采购未审批(42%)', topicId: '#3011' },
  { id: 'a2', severity: 'critical' as const, title: '12家风险供应商需处置', desc: '其中3家高风险(串标嫌疑),5家中风险(质量不合格),4家低风险', topicId: '#3004' },
  { id: 'a3', severity: 'warning' as const, title: '招标节约率6.5%,低于目标8%', desc: '主要为设备类招标竞争不充分,建议扩大供应商池', topicId: null },
];

const REGIONS = [
  { id: 'r1', name: '华北采购中心', region: '华北', stores: 45, revenue: '60 / 55亿', member_rate: '88.5%' },
  { id: 'r2', name: '华东采购中心', region: '华东', stores: 38, revenue: '45 / 42亿', member_rate: '91.2%' },
  { id: 'r3', name: '华南采购中心', region: '华南', stores: 28, revenue: '30 / 28亿', member_rate: '89.8%' },
  { id: 'r4', name: '西北采购中心', region: '西北', stores: 32, revenue: '35 / 30亿', member_rate: '85.3%' },
];
...
const AGENT_INFO: Record<string, { initial: string; title: string }> = {
  a_bid: { initial: '招', title: '招采合规Agent' },
  a_supplier: { initial: '供', title: '供应商风控Agent' },
  a_contract: { initial: '合', title: '合同审查Agent' },
  a_risk: { initial: '风', title: '风控Agent' },
  a_audit: { initial: '审', title: '审计线索Agent' },
  a_cost: { initial: '成', title: '成本优化Agent' },
